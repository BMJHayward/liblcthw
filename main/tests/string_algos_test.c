...
char *test_find_and_scan()//confirms the tests actually work
{
...
char *test_binstr_performance()//starting time with start then TEST_TIME is length of time test runs for
{
    int i = 0;
    int found_at = 0;
